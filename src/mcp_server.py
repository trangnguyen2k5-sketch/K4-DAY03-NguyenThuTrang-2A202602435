...
class MCPAcademicServer:
    ...
    def call_tool(self, tool_name: str, arguments: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            result_dict = {"status": "PARSE_ERROR", "content": raw_result}
...
if __name__ == "__main__":
    ...
    server = MCPAcademicServer("vinbus-mcp-server")
    tools = server.list_tools()
    print(f"✅ Khởi tạo thành công MCP Server: {server.server_name} (Version: {server.version})")
    print(f"📦 Số lượng Tools công bố: {len(tools)}")
    
    # Kiểm tra trạng thái call_tool
    test_result = server.call_tool("get_route_details", {"route_id": "E03"})
    if not test_result or not test_result.get("result"):
        ...
        print(f"✅ [TODO 2.1]: Test dispatch tool 'get_route_details' thành công:")
